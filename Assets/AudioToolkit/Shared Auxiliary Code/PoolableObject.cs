    ...
    internal class ObjectPool
    {
        ...
        internal void _SetAvailable( PoolableObject poolObj, bool b )
        {
            ...
            if ( b )
            {
                ...
                objTransform.SetParent(null); // object could still be parented, so detach

                _RecursivelySetInactiveAndSendMessages( poolObj.gameObject, poolObj, false );

                objTransform.SetParent(poolObj._myPool.poolParentDummy); // attach to dummy Parent
            ...
            {
                objTransform.SetParent(null); // detach from poolParentDummy
